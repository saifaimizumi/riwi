...
local Tabs = {
    ...
    Stat = Window:AddTab({ Title = "Stat Tab", Icon = "rbxassetid://110401460845589" }),
...
local ToggleMelee = Tabs.Stat:AddToggle("ToggleMelee", {Title = "Melee",Description = "", Default = false })
